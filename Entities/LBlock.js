        ...
        if(direction == 1) {
            if(this.rotation == 0) {
                if(this.xPos+1 != size
                    ...
                    && board[this.xPos+2][this.yPos+2] != 1) {
                    this.xPos += direction;
                }
            } else if(this.rotation == 90) {
                if(this.xPos+1 != size
                    && board[this.xPos+3][this.yPos] != 1
                    && board[this.xPos+1][this.yPos+1] != 1) {
                    this.xPos += direction;
                }
            } else if(this.rotation == 180) {
                if(this.xPos+1 != size
                    ...
                    && board[this.xPos+2][this.yPos+1] != 1
                    && board[this.xPos+2][this.yPos+2] != 1) {
                    this.xPos += direction;
                }
            } else if(this.rotation == 270) {
                if(this.xPos+1 != size
                    && board[this.xPos+3][this.yPos] != 1
                    && board[this.xPos+3][this.yPos+1] != 1) {
                    this.xPos += direction;
                }
            }
        } else if(direction == -1) {
            if(this.rotation == 0) {
                ...
                if(this.xPos != 0
                    && board[this.xPos-1][this.yPos] != 1
                    && board[this.xPos][this.yPos+1] != 1
                    && board[this.xPos][this.yPos+2] != 1) {
                    this.xPos += direction;
                }
            } else if(this.rotation == 270) {
                if(this.xPos != 0
